...
async def lifespan(app: FastAPI):
    ...
    _apscheduler.start()
    logger.info(
        "APScheduler started — daily OHLCV (Mon-Fri 05:30 UTC), "
        "semi-annual Eulerpool refresh (28 Jun & 28 Dec 04:00 UTC), "
...
_CORS_ORIGINS = [
    "https://snaikecursor.github.io",
    "https://stephangath.github.io",
    "http://localhost:5173",
    "http://localhost:3000",
]
